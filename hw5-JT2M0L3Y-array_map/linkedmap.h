...
// DATE: Fall 2021
// DESC: My class definition for the Map ADT using prior LinkedSeq class.
//---------------------------------------------------------------------------
...
const V& LinkedMap<K,V>::operator[](const K& key) const
{
  ...
  throw std::out_of_range("operator[]: key not in map");
}
